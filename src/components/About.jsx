    ...
    <section className={classes.about}>
        ...
        <div className={classes['about-me__down-side']}>
            <div className={classes['get-to-know-me']}>
                ...
                <p className={classes['down__paragraph']}>I'm a Frontend Web Developer building the Front-end of Websites and Web Applications that leads to the success of the overall product. Check out some of my work in the Projects section. </p>
