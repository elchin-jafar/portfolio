  ...
  return (
    <>
      <div className={classes.container}>
        ...
        <Transition nodeRef={nodeRef} in={isMenuOpen} timeout={1000} mountOnEnter unmountOnExit>
          {state => (<div ref={nodeRef} className={classes.responsiveMenuContainer} style={{...defaultStyle, ...transitionStyles[state]}}>
